      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">How to use</h2>
          </div>
        </div>
        <div class="row text-center">
          <div class="col-md-4">
            ...
            <p class="text-muted">Take a picture of inside your bag.</p>
            <!--バッグの中身を写真に撮る  -->
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
            ...
            <h4 class="service-heading">POST</h4>
            <p class="text-muted">Post an article with some pictures.</p>
            <!-- 写真と一緒にバッグの中身を投稿する -->
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
            ...
            <h4 class="service-heading">Inside your bag</h4>
            <p class="text-muted">Let' share inside your bag.</p>
            <!-- さあみんなでバッグの中身をシェアしましょう -->
          </div>
        </div>
      </div>
    </section>
