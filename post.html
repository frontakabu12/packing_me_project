    ...
    <div>
      ...
      <div class="post-form">
        <form action="home.html">
          ...
          <center>場所</center>
          <input type="" name="" placeholder="例）フィリピン　セブ島">
          <center>期間</center>
          <input type="" name="" placeholder="例）４日間">
          <center>backpack</center>
          <input type="" name="" placeholder="例）the north face Caelus 35L">
          <center>重量</center>
          <input type="" name="" placeholder="例）13kg">
          <center>中身詳細</center>
          <textarea placeholder="例）mackbookpro, dji spark, omd-em5 mark2, t-shirts 3, pants 3..."></textarea>
          <a href="home.html"><button>投稿する</button></a>
        </form>
       </div> 
