    ...
    <div class="right-right">
      <div class="right-caram">
        ...
        <div class="profile-texts">
          ...
          <div class="buttons">
            <div class="be-center"><a href="mypage.html"><button class="like-button">投稿一覧</button></a></div>
            <br>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <i class="fa fa-suitcase fa-2x"> 5 like</i>
              <!-- <p class="text-more">more</p> -->
            </div>
          </div>
          <div class="col-md-6 col-sm-6 portfolio-item">
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="nao.png" alt="">
