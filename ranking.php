      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="home.html">Log out</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12  portfolio-item">
            ...
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
              ...
              <img class="img-fluid" src="zaki.png" width="600" height="400" alt="">
            </a>
            <div class="portfolio-caption">
              <i class="fa fa-suitcase fa-2x"> 200,000 like</i>
          ...
          <div class="col-lg-12 col-sm-6 portfolio-item">
            ...
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
              ...
              <img class="img-fluid" src="nao.png" width="600" height="400" alt="">
            </a>
            <div class="portfolio-caption">
          ...
          <div class="col-lg-12 col-sm-6 portfolio-item">
            ...
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
              ...
              <img class="img-fluid" src="packing.png" width="600" height="400" alt="">
            </a>
            <div class="portfolio-caption">
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <img src="img/portfolio/small-crown.png" width="60" height="60" ><p>No.4</p></div>
            ...
            <div class="portfolio-caption">
              <i class="fa fa-suitcase fa-2x"> 67 like</i>
              <!-- <p class="text-more">more</p> -->
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <div class="small-crown">
            <img src="img/portfolio/small-crown.png" width="60" height="60" ><p>No.5</p></div>
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal5">
              ...
              <img class="img-fluid" src="naonaonao.png" alt="">
            </a>
            <div class="portfolio-caption">
              <i class="fa fa-suitcase fa-2x"> 50 like</i>
              <!-- <p class="text-more">more</p> -->
            </div>
          </div>
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <div class="small-crown">
            <img src="img/portfolio/small-crown.png" width="60" height="60" ><p>No.6</p></div>
            ...
            <div class="portfolio-caption">
              <i class="fa fa-suitcase fa-2x"> 33 like</i>
              <!-- <p class="text-more">more</p> -->
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <div class="small-crown">
            <img src="img/portfolio/small-crown.png" width="60" height="60" ><p>No.7</p></div>
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal4">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <i class="fa fa-plus fa-3x"></i>
            ...
            <div class="portfolio-caption">
              <i class="fa fa-suitcase fa-2x"> 27 like</i>
              <!-- <p class="text-more">more</p> -->
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <div class="small-crown">
            <img src="img/portfolio/small-crown.png" width="60" height="60" ><p>No.8</p></div>
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal5">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <i class="fa fa-plus fa-3x"></i>
            ...
            <div class="portfolio-caption">
              <i class="fa fa-suitcase fa-2x"> 20 like</i>
              <!-- <p class="text-more">more</p> -->
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            <div class="small-crown">
            <img src="img/portfolio/small-crown.png" width="60" height="60" ><p>No.9</p></div>
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal6">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <i class="fa fa-plus fa-3x"></i>
            ...
            <div class="portfolio-caption">
              <i class="fa fa-suitcase fa-2x"> 11 like</i>
              <!-- <p class="text-more">more</p> -->
            </div>
          </div>
        </div>
